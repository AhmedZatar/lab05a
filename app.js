...
function sumArray(sumArr) { //eslint-disable-line
    ...
    let arr= []
    arr[0]=testArray[0]+testArray[1]+testArray[2];
    arr[1]=testArray[0]+','+testArray[1]+','+testArray[2]+' was passed in as an array of numbers, and '+arr[0]+' is their sum.'
...
function multiplyArray(multArr) { //eslint-disable-line
    let arr= []
    arr[0]=testArray[0]*testArray[1]*testArray[2];
    arr[1]='The numbers '+testArray[0]+','+testArray[1]+','+testArray[2]+' have a product of '+arr[0]+'.'
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    arr[0]=a;
    arr[1]=arr[1]+' have a product of '+arr[0]+'.';
    return arr;
}
